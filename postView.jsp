...
<%
    ...
    PreparedStatement commentPreparedStatement = connect.prepareStatement(commentQuery);
    ...
    ArrayList<String> idList = new ArrayList<>();
        ...
        while (commentResultSet.next()) {
            String id = commentResultSet.getString(1);
            String commentContent = commentResultSet.getString(2);
            Timestamp time = commentResultSet.getTimestamp(3);
            int commentIdx = commentResultSet.getInt(4);
            ...
            commentTimeList.add("'" + formattedTime + "'");
        }
...
<div id="commentSection">
   ...
   var commentTimeList = <%=commentTimeList%>;
   var commentContentList = <%=commentContentList%>;


   var commentSection=document.getElementById("commentSection");

   for(var i=0;i<commentIdxList.length;i++){
    var commentBox = document.createElement("div"); 
    var cmIdx = document.createElement("input"); 
    ...
    cmIdx.name="cmIdx";
    cmIdx.type="hidden";
    cmIdx.value=commentIdxList[i];

    spanTitle.innerText=commentContentList[i];
    spanWriter.innerText=idList[i];
    spanTime.innerText=commentTimeList[i];

    //form.action = "postView.jsp";
    commentBox.appendChild(spanTitle);
    commentBox.appendChild(spanWriter);
    commentBox.appendChild(spanTime);
    commentBox.appendChild(cmIdx);
